...
import { DemoV0, DemoV1 } from "@/components/VersionDemos";
              ...
              <>
                ...
                <div>
                  <h3 className="cn-tile-title" style={{ fontSize: "20px" }}>
                    Client list — <code>useState</code> + <code>useEffect</code>, a spinner, then data.
                  </h3>
                  <p className="cn-tile-sub" style={{ marginTop: "6px", fontSize: "13.5px" }}>
                    The familiar W5D1 pattern: mount the component, run an effect, set state.
                    v2 deletes both hooks.
                  </p>
                </div>
              </>
            }
