      ...
      <section className="cn-section">
        ...
        <div className="cn-bento">
          <div className="cn-tile span-12 cn-tile-yellow">
            <div className="cn-tile-meta">v1 · you are here</div>
            <div>
              <h3 className="cn-tile-title" style={{ fontSize: "20px" }}>
                /tasks reads from <code>lib/tasks.ts</code> via <code>useState</code> +{" "}
                <code>useEffect</code>.
              </h3>
              <p className="cn-tile-sub" style={{ marginTop: "6px", fontSize: "13.5px" }}>
                The W5D1 React pattern, dropped into a Next.js page. The browser renders
                an empty list, hydrates, fires the effect, then re-renders with data.
                Sets up the v2 contrast.
              </p>
            </div>
          </div>
          ...
          <div className="cn-tile span-6">
            ...
            <p className="cn-tile-sub">
              Home, /tasks (empty), /about — no data layer. The lesson was the file
              structure itself.
            </p>
          </div>
          <div className="cn-tile span-6">
