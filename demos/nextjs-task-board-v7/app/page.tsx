  ...
  return (
    <main className="cn-page">
      ...
      <section className="cn-section">
        ...
        <h2 className="cn-section-h">Your board lives in this browser.</h2>
          ...
          <div className="cn-tile span-12">
            ...
            <div>
              <h3 className="cn-tile-title" style={{ fontSize: "18px" }}>
                Tasks you create or edit are saved in this browser and survive a
                refresh — but they don&apos;t follow you to another device or
                browser.
              </h3>
              <p
              ...
              >
                Cadence keeps your board in local storage, so it&apos;s here when
                you come back on this machine. Signing in and syncing the same
                tasks across every device is what a backend adds — that&apos;s the
                next step.
              </p>
            </div>
          </div>
