  ...
  return (
    <main className="cn-page">
      ...
      <section className="cn-section">
        ...
        <h2 className="cn-section-h">A real backend behind a real login.</h2>
        <p
          className="cn-tile-sub"
          style={{ fontSize: "14px", lineHeight: 1.6, maxWidth: "62ch" }}
        >
          Sign in and your board is saved to a database, scoped to your account.
          Log in on another browser or device and the same tasks are there. The
          board loads over an API, your password is stored as a one-way hash, and
          the planning weather is fetched through the server so its API key stays
          private.
        </p>
      </section>
