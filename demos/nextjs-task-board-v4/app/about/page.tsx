              ...
              <>
                ...
                <div>
                  <h3 className="cn-tile-title" style={{ fontSize: "20px" }}>
                    Dynamic detail route — <code>app/tasks/[id]/page.tsx</code>.
                  </h3>
                  <p className="cn-tile-sub" style={{ marginTop: "6px", fontSize: "13.5px" }}>
                    One file, one URL per task. <code>generateStaticParams()</code>
                    pre-renders every known id at build time. Server component, no spinner.
                  </p>
                </div>
              </>
            }
