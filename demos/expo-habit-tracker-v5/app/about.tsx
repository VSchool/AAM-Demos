...
const SOURCE = "https://github.com/VSchool/AAM-Demos/tree/main/demos/expo-habit-tracker-v5";
        ...
        <ScrollView contentContainerStyle={{ padding: 18, gap: 22 }}>
          <Section tag="What this is">
            ...
            <Text style={{ fontFamily: FONTS.sans, fontSize: 14, lineHeight: 21, color: theme.textMuted }}>
              ...
              each version adding exactly one mobile concept. You're looking at v5 — the dynamic-route detail screen.
            </Text>
          </Section>
          ...
          <Section tag="The seven states">
            ...
            <Text style={{ fontFamily: FONTS.sans, fontSize: 12.5, lineHeight: 19, color: theme.textMuted }}>
              Scaffold → tabs → list + form → swipe → storage → dynamic-route detail → push + coach. v5 is the
              detail screen you reach by tapping a channel; v6 adds push reminders on top.
            </Text>
          </Section>
