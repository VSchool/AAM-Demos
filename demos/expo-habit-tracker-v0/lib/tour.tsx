...
/* v0's steps. The scaffold is a single static screen — nothing to ring yet,
   so both steps are explanatory: what's here, and what gets added next. */
export const V0_TOUR: TourStep[] = [
  {
    tag: "v0 · the scaffold",
    title: "This is the starting point",
    body:
      "v0 is the bare scaffold: a single Today screen that renders five habit “channels” from typed sample data — each with an indicator LED, a streak readout, and a switch. It's read-only for now.",
  },
  {
    tag: "what's next",
    title: "One concept at a time",
    body:
      "From here each version adds exactly one thing: tab navigation (v1), a live list + add form (v2), the swipe “throw” (v3), persistence (v4), a detail route (v5), and push notifications (v6).",
  },
];
