...
/* v1's steps. The new beat is tab navigation, so the first step rings the
   tab bar; the second explains the file-based routing behind it. */
export const V1_TOUR: TourStep[] = [
  {
    tag: "v1 · what's new",
    title: "Three tabs now",
    body:
      "Since the scaffold, Pulse has real navigation — Today, Streaks, and Settings. Tap along the bar at the bottom to move between them; each is its own screen.",
    target: "tab-bar",
  },
  {
    tag: "file-based routing",
    title: "Expo Router tabs",
    body:
      "The tabs come from Expo Router: a (tabs) group + a tab layout turns three sibling files into a tab bar — no manual navigator wiring. The live list, the add form, and completing habits arrive next.",
  },
];
