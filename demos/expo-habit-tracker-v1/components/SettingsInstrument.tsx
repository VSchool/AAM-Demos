    ...
    <View style={{ flex: 1 }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 14, gap: 12 }}>
        ...
        >
          ...
          >
            v1 is read-only — Today shows a static seed roster. A live list with an add form (v2),
            completing a habit (v3) and persistence (v4) come next. No account, no cloud, no server;
            the login is a mock.
          </Text>
        </View>
      </ScrollView>
