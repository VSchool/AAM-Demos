      ...
      <section className="cn-section">
        ...
        <div className="cn-bento">
          <div className="cn-tile span-12 cn-tile-yellow">
            ...
            <div>
              <h3 className="cn-tile-title" style={{ fontSize: "20px" }}>
                /tasks is now an async server component —{" "}
                <code>const tasks = getTasks()</code>, no hooks, no flicker.
              </h3>
              <p className="cn-tile-sub" style={{ marginTop: "6px", fontSize: "13.5px" }}>
                Server components run on the server (at build time for this static
                export) and render to HTML before anything ships. The browser receives a
                complete document with every task already in it.
              </p>
            </div>
          </div>
          ...
          <div className="cn-tile span-4">
            ...
            <h3 className="cn-tile-title">Three file-routed pages</h3>
            <p className="cn-tile-sub">
              Home, /tasks (empty), /about — no data layer.
            </p>
          </div>
          <div className="cn-tile span-4">
            ...
            <p className="cn-tile-sub">
              The W5D1 pattern, with a loading skeleton during the simulated client fetch.
            </p>
          </div>
          <div className="cn-tile span-4">
            <div className="cn-tile-meta">v3 · client filter</div>
            <h3 className="cn-tile-title">&quot;use client&quot; wrapper</h3>
            <p className="cn-tile-sub">
              Filter + sort + view toggle on top of the server-rendered list.
            </p>
          </div>
