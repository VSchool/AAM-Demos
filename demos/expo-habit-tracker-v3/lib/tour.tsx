...
/* v3's steps. The new beat — "the throw" — is a gesture on the rows, so the
   first step rings a channel and explains the swipe; the second explains the
   primitive behind it. */
export const V3_TOUR: TourStep[] = [
  {
    tag: "v3 · what's new",
    title: "Throw the switch",
    body:
      "Since the last version, channels respond to a gesture. Swipe a row to the right — or just tap it — to throw the switch and complete the habit: the LED snaps green and the streak ticks up.",
    target: "first-channel",
  },
  {
    tag: "the throw",
    title: "A satisfying commit",
    body:
      "The swipe is v3's beat — react-native-gesture-handler drives the pan and a haptic “thunk” fires on a real phone. Everything else carried over: the channel list and the add-a-channel form.",
  },
];
