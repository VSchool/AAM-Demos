...
const SOURCE = "https://github.com/VSchool/AAM-Demos/tree/main/demos/expo-habit-tracker-v3";
        ...
        <ScrollView contentContainerStyle={{ padding: 18, gap: 22 }}>
          <Section tag="What this is">
            ...
            <Text style={{ fontFamily: FONTS.sans, fontSize: 14, lineHeight: 21, color: theme.textMuted }}>
              ...
              each version adding exactly one mobile concept. You're looking at v3 — the throw (swipe to complete).
            </Text>
          </Section>
          ...
          <Section tag="The seven states">
            ...
            <Text style={{ fontFamily: FONTS.sans, fontSize: 12.5, lineHeight: 19, color: theme.textMuted }}>
              Scaffold → tabs → list + form → swipe → storage → dynamic-route detail → push + coach. v3 adds
              the gesture "throw"; persistence (v4), the detail route (v5) and push (v6) come later.
            </Text>
          </Section>
          ...
          <Section tag="Session-only, on purpose">
            ...
            >
              <Text style={{ fontFamily: FONTS.sans, fontSize: 13, lineHeight: 20, color: theme.textMuted }}>
                ...
                Persistence (AsyncStorage) is the v4 beat. No account, no cloud, no server; the login
                is a mock, and wiring real auth is an optional next step you choose.
              </Text>
            </View>
          </Section>
