...
/* v4's steps. Persistence isn't a visible element to ring, so these are
   explanatory (no spotlight) — they explain what now survives a refresh and
   where the data lives. */
export const V4_TOUR: TourStep[] = [
  {
    tag: "v4 · what's new",
    title: "Pulse remembers now",
    body:
      "Since the last version, your channels persist. Throw a switch, patch in a channel, park one on a rest day — then refresh, and it's all still here. Everything else carried over: swipe right to complete, swipe left for a kind rest day.",
  },
  {
    tag: "how it works",
    title: "Saved on this device",
    body:
      "The store hydrates from AsyncStorage on launch and writes back on every change — no account, no cloud, no server (on the web build that's localStorage; on a phone it's device storage). Need a clean slate? Reset to seed lives in Settings.",
  },
];
