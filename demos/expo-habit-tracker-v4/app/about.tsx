...
const SOURCE = "https://github.com/VSchool/AAM-Demos/tree/main/demos/expo-habit-tracker-v4";
        ...
        <ScrollView contentContainerStyle={{ padding: 18, gap: 22 }}>
          <Section tag="What this is">
            ...
            <Text style={{ fontFamily: FONTS.sans, fontSize: 14, lineHeight: 21, color: theme.textMuted }}>
              ...
              each version adding exactly one mobile concept. You're looking at v4 — where your channels start to persist.
            </Text>
          </Section>
          ...
          <Section tag="The seven states">
            ...
            <Text style={{ fontFamily: FONTS.sans, fontSize: 12.5, lineHeight: 19, color: theme.textMuted }}>
              Scaffold → tabs → list + form → swipe → storage → dynamic-route detail → push + coach. v4 makes the
              roster persist with AsyncStorage; later versions add the detail route (v5) and push (v6).
            </Text>
          </Section>
          ...
          <Section tag="On-device, on purpose">
            ...
            >
              <Text style={{ fontFamily: FONTS.sans, fontSize: 13, lineHeight: 20, color: theme.textMuted }}>
                Your channels save on this device with AsyncStorage — no account, no cloud, no
